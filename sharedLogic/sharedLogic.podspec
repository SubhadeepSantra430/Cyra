Pod::Spec.new do |spec|
    ...
    spec.version                  = '1.0'
    spec.homepage                 = 'https://github.com/subha/Cyra'
    spec.source                   = { :http=> ''}
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'Cyra shared business logic'
    ...
    spec.dependency 'FirebaseFirestoreInternal', '11.8.0'
    spec.dependency 'FirebaseStorage', '11.8.0'
